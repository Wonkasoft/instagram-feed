 ...
 * @param array $field
 */
function wc_insta_text_input( $field ) {
 ...
 * @param array $field
 */
function wc_insta_hidden_input( $field ) {
 ...
 * @param array $field
 */
function wc_insta_textarea_input( $field ) {
 ...
 * @param array $field
 */
function wc_insta_checkbox( $field ) {
 ...
 * @param array $field
 */
function wc_insta_select( $field ) {
